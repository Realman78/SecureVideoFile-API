...
import { errorHandler, createFile, fetchFile, deleteFile, updateFile, fetchAllFiles, verifyFile } from '../controllers/file/fileController'
...
router.post('/verify/:id', validator.body(verifySchema), protect, verifyFile)
