...
## End-point: Resend confirmation mail
### Method: GET
>```
>{{url}}/api/auth/confirm/resend/:id
>```
...
## End-point: Delete User and his Files
### Method: DELETE
>```
>{{url}}/api/auth/delete
>```
...
## End-point: Fetch a file using url or file name
### Method: POST
>```
>{{url}}/api/file/fetch
>```
...
## End-point: Update file name
### Method: PATCH
>```
>{{url}}/api/file/update/:id
>```
### 🔑 Authentication bearer
...
## End-point: Fetch all user files
### Method: GET
>```
>{{url}}/api/file/fetch/all
>```
### 🔑 Authentication bearer
...
## End-point: Verify File
### Method: POST
>```
>{{url}}/api/file/verify/643ae959490de2a1e2860a16
>```
### 🔑 Authentication bearer
